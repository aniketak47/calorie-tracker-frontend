...
const Entries = () => {
    ...
    const [newEntry, setNewEntry] = useState({"dish":"", "ingredient":"", "calories": 0, fat: 0})
        ...
        <div>
            ...
            <Modal.Body>
                <Form.Group>
                    ...
                    <Form.Control onChange={(event) => {newEntry.ingredient = event.target.value}}></Form.Control>
    ...
    function addSingleEntry(){
        ...
        axios.post(url, {
            "ingredients": newEntry.ingredient,
            "dish": newEntry.dish,
